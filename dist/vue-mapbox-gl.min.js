var Mapbox = (function (t, e) {
  ...
  function O(t) {
    return function (e, o, n) {
      var r = o.replace(b, '-$1').toLowerCase(),
        i = n.value
      n.value = function () {
  ...
  C._withStripped = !0
  const j = (function (t, e, o, n, r, i, a, c, s, p) {
  ...
  var x,
    P = {
      install: (x = function (t) {
        x.installed || ((x.installed = !0), t.component('Mapbox', j))
      }),
    },
    R = null
  return (
    'undefined' != typeof window && (R = window.Vue),
    R && R.use(P),
    (t.default = j),
    t
  )
