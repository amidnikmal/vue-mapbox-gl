...
function _(t) {
  return function (e, o, n) {
    var r = o.replace(O, '-$1').toLowerCase(),
      i = n.value
    n.value = function () {
...
const C = (function (t) {
  ...
  return (
    ...
    o([b({ required: !0 })], n.prototype, 'accessToken', void 0),
    o([b({ required: !0 })], n.prototype, 'mapOptions', void 0),
    o(
      [
        b({
          default: function () {
...
var P,
  R = {
    install: (P = function (t) {
      P.installed || ((P.installed = !0), t.component('Mapbox', x))
    }),
  },
  $ = null
'undefined' != typeof window && ($ = window.Vue), $ && $.use(R)
export default x
